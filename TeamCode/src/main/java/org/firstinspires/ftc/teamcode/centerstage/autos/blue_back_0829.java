...
@Autonomous (name = "Blue Back Aug 29")
@Disabled
public final class blue_back_0829 extends LinearOpMode {
    ...
    private final int r = 0;    //  蓝0        红100
    private final int rs = 10;   //  蓝10       红124
    private final int g = 43;     //
    private final int gs = 255;   //
    private final int b = 46;     //
    private final int bs = 255;   //
    ...
    public class Lift {
        ...
        public class LiftUp implements Action {
            ...
            public boolean run(@NonNull TelemetryPacket packet) {
                ...
                if (!initialized) {
                    telemetry.addData("Position", rightViper.getCurrentPosition());
                    telemetry.update();
                    rightViper.setPower(0.8);
                    leftViper.setPower(0.8);
                    initialized = true;
                }

                double pos = rightViper.getCurrentPosition();
    ...
    public class IntakeDrop {
        private final Servo intake_drop;
