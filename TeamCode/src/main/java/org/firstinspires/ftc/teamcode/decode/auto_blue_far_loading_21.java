...
@Autonomous (name = "decode auto blue far loading 21")

public final class auto_blue_far_loading_21 extends LinearOpMode {
    DcMotor FR;
    DcMotor FL;
    DcMotor BR;
    DcMotor BL;
...
//
        ...
        TrajectoryActionBuilder go_from_shoot_to_loading = go_shoot_held_artifacts.endTrajectory().fresh()
        ...
        // go to GPP
        TrajectoryActionBuilder go_from_shoot_to_GPP = go_shoot_loading.endTrajectory().fresh()
        ...
        //LEAVE
        TrajectoryActionBuilder go_leave_loading = go_shoot_GPP.endTrajectory().fresh()
...
//                            go_scan_obelisk.build(),
            ...
            if (target21Found == true) { // loading then GPP
                Actions.runBlocking(new SequentialAction(
            ...
            } else if  (target22Found == true) { //still loading then GPP
                Actions.runBlocking(new SequentialAction(
            ...
            } else if  (target23Found == true) { //still loading then GPP
                Actions.runBlocking(new SequentialAction(
