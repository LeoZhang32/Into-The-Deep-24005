...
@Autonomous (name = "auto_specimen_test6")

public final class auto_specimen_test6 extends LinearOpMode {
    ...
    public class Lift {
        ...
        public Action Liftspecimen0Up() {
            return new Lift.Liftspecimen0Up();
        }
