...
@Autonomous (name = "auto_SAMPLE_0plus5_blue_middle")

public final class auto_SAMPLE_0plus5_Blue_Mid extends LinearOpMode {
    DcMotor FR;
    DcMotor FL;
    DcMotor BR;
    DcMotor BL;
...
//add limelight movement here
            ...
            Actions.runBlocking(new SequentialAction(
                    ...
                    oclaw.OpenOClaw(),
                    new SleepAction(0.2),
                    // sample 1 cycle completes by now. sample 4 cycle starts below
                    new ParallelAction(
                        go_to_sub_4a.build(),
                        oarm.LowerOArm(),
                        lift.liftDown(),
                        ...
                        if (result.isValid() && result.getTa() > 0.01 && LLCorrectionTimer.seconds() <= 1) {
                            ...
                            if (result.getTy() < -1) {
                                ...
                                if (result.getTx() > 1) {
                                    ...
                                    FR.setPower(0);
                                    BL.setPower(0);
                                    telemetry.addData("limelight loop 4a breaks - 2nd pipeline", FL.getPower());
                                    telemetry.update();
                                    sample4detected = true;
                                    break;
                                }
                        ...
                        if (result.isValid() && result.getTa() > 0.01 && LLCorrectionTimer.seconds() <= 1) {
                            ...
                            if (result.getTy() < -1) {
                                ...
                                if (result.getTx() > 1) {
                                    ...
                                    FR.setPower(0);
                                    BL.setPower(0);
                                    telemetry.addData("limelight loop 4b breaks - yellow pipeline", FL.getPower());
                                    telemetry.update();
                                    sample4detected = true;
                                    break;
                                }
                        ...
                        if (result.isValid() && result.getTa() > 0.01 && LLCorrectionTimer.seconds() <= 1) {
                            ...
                            if (result.getTy() < -1) {
                                ...
                                if (result.getTx() > 1) {
                                    ...
                                    FR.setPower(0);
                                    BL.setPower(0);
                                    telemetry.addData("limelight loop 4b breaks - 2nd pipeline", FL.getPower());
                                    telemetry.update();
                                    sample4detected = true;
                                    break;
                                }
            ...
            FR.setPower(0);
            BL.setPower(0);
            //limelight correction 4b position red/blue pipeline completes.
            drive.updatePoseEstimate();
            Actions.runBlocking(new SequentialAction(
                    new ParallelAction(
                            intake.SettoAim(),
